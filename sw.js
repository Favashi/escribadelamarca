...
const SHELL = [
  ...
  './js/views/profile.js', './js/views/supporter.js', './js/views/review.js', './js/nav.js', './js/version.js', './js/views/finder.js', './js/views/wishlist-public.js', './js/views/admin.js', './js/track.js', './js/update.js', './js/navlist.js', './js/icons.js', './js/export.js', './js/settings.js', './js/announcement.js', './js/achievements.js',
